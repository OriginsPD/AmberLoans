...
@php
    ...
    $classes = 'block w-full px-4 py-2 mt-2 text-gray-700 bg-white border
                   ...
                   focus:outline-none transition overflow-auto overflow-ellipsis duration-300 form-select
...
<div>
    ...
    <select {{ $attributes->merge(['class' => $classes]) }}>
        ...
        <option selected disabled> {{ trans('auth.select', ['attribute' => $field]) }} </option>
